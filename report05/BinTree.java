...
public class BinTree {
	   ...
	   public static void main(String[] args) {
	      ...
	      n1.setLeft(n2);      //n1의 왼쪽 자식 -> n2
	      n1.setRight(n3);   //n1의 오른쪽 자식 -> n3
	      n2.setLeft(n4);      //n2의 왼쪽 자식 -> n4
	      n2.setRight(n5);   //n2의 오른쪽 자식 -> n5
	      n3.setLeft(n6);      //n3의 왼쪽 자식 -> n6
	      n3.setRight(n7);   //n3의 오른쪽 자식 -> n7
	      ...
	      //두번쨰 이진 트리를 만들어 isEqual() 테스트 하기 위해   
